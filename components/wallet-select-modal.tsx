...
import { X, ArrowRight, Download, ExternalLink } from "lucide-react";
          ...
          >
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-sm">
                {allWallets.length === 0
                  ? "No wallet detected. Download Phantom to get started"
                  : "Choose your preferred Solana wallet to continue"}
              </p>
            </div>

            {/* No wallets detected - Show download prompt */}
            {allWallets.length === 0 ? (
              <motion.div
              ...
              >
                <div className="text-center">
                  <div className="relative inline-block mb-4">
                    <div className="absolute inset-0 bg-gradient-to-r from-purple-500/30 to-yellow-500/30 rounded-full blur-xl"></div>
                    <div className="relative w-24 h-24 rounded-full bg-white dark:bg-gray-700 border-4 border-purple-500/30 dark:border-purple-400/30 flex items-center justify-center overflow-hidden shadow-lg mx-auto">
                      <img
                        src={WALLET_METADATA.Phantom.icon}
                        alt="Phantom"
                        className="w-20 h-20 object-contain"
                        onError={(e) => {
                          const target = e.target as HTMLImageElement;
                          target.src = "https://phantom.app/img/phantom-icon-purple.svg";
                        }}
                      />
                    </div>
                  </div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm mb-6 max-w-md mx-auto">
                    Phantom is a popular Solana wallet. Download it and add it to your browser extension to get started.
                  </p>
                </div>

                <motion.a
                  href={WALLET_METADATA.Phantom.installUrl}
                  target="_blank"
                ...
                >
                  <motion.div
                    className="flex items-center justify-center gap-4 p-6 border-4 border-purple-500 dark:border-purple-400 bg-gradient-to-r from-purple-500/10 to-yellow-500/10 hover:from-purple-500/20 hover:to-yellow-500/20 rounded-xl transition-all duration-300 shadow-lg hover:shadow-purple-500/30"
