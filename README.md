...
[![Demo Video](https://img.shields.io/badge/CandyCrush-Video-pink)](https://youtu.be/g3VTWRgRqyU?si=Uwooee8BLzCHVaM1)
[![Status](https://img.shields.io/badge/Status-MVP%20Live-brightgreen)](https://www.empireofbits.fun/)
...
> _An Interoperable Arcade Gaming Ecosystem on Solana where assets, achievements, and experiences transcend individual games. Powered by the revolutionary Viewer-Influence Loop._
...
- _Passive Viewing_: Live stream viewers have minimal ways to meaningfully interact with gameplay
...
- _Blockchain_: Solana
- _Frontend_: React, Next.js, Three.js, BabylonJS
- _Smart Contracts_: Rust, Anchor Framework
- _Infrastructure_: Vercel, AWS
- _Integrations_: Airdrop Arcade, Magickblocks, Sonic
